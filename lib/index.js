...
(function() {
  var InterpolationError, PathExp, UNCATEGORIZABLE, fill, groupsContainClashes, slug, slugify, _, _ref;

  _ = require('underscore');

  slug = require('slug');

  _ref = require('simple-path-expressions'), PathExp = _ref.PathExp, InterpolationError = _ref.InterpolationError;
  ...
  fill = function(pattern, obj, options) {
    ...
    slugifiedObj = _.object(_.compact(_.map(obj, function(value, key) {
      if (_.contains([Object, Array], value != null ? value.constructor : void 0)) {
        return void 0;
      } else {
